...
A comparação dos tempos se encontra em "lab4_tempos.txt"!
...
#include <pthread.h>
#include "timer.h"
#include "lab4_leitorEscritor_v2.h"
...
int main(int argc, char* argv[]) {
   ...
   //função para inicializar as variáveis condicionais
   inic();
   ...
   //função para destruir as variáveis condicionais
   destroi();
