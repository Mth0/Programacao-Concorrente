...
A versão 1 tinha alguns erros, desculpe. Essa versão em comparativo com a versão 1:

	-aqui corrigi o erro do #include "timer.h", não o havia posto na primeira versão.
	-tratei um problema de segmentation fault que dava na contagem do argc.
	-ajeitei um comentário.
...
//funcao que as threads executarao, cada thread tera seu calculo de primos encontrados
...
int main(int argc, char* argv[]){
	...
	if(sequencia == NULL){printf("ERRO: malloc"); return 2;}
