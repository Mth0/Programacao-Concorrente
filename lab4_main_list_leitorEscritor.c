...
Cópia do código "main_list_rwlock.c" com a mudança de rwlock para minha
implementação do "pattern" leitor/escritor.

Infelizmente não consegui comparar os tempos de execução na minha máquina, pois o resultado final
não me era mostrada na tela, apesar da versão da professora funcionar perfeitamente.

Adicional a isso, meu código parecia funcionar normalmente nas máquinas do laboratório, então não
sei ao certo o que estava/está ocorrendo.
